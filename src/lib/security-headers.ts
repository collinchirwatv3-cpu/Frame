 ...
 *
 * Known, accepted gaps in this starting policy:
 ...
 *  - `commondatastorage.googleapis.com` (media-src) is the public Google
 *    sample-video bucket used for mock content — remove this the moment real
 *    Cloudflare Stream playback URLs replace it; it has no place in a real
 *    production policy.
 *  - `picsum.photos` (img-src) is mock avatar/poster imagery — same as above.
...
export function buildContentSecurityPolicy(nonce: string): string {
  ...
  const directives: Record<string, string[]> = {
    ...
    "img-src": [
      ...
      "https://*.r2.dev",
      "https://picsum.photos",
      "https://*.picsum.photos", // picsum serves actual images off fastly.picsum.photos — mock content, remove once real posters/avatars replace it
    ...
    "media-src": [
      ...
      "https://*.r2.dev",
      "https://videodelivery.net",
      "https://commondatastorage.googleapis.com", // mock sample videos — remove before launch
    ],
