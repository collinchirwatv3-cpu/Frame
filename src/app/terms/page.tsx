...
export const metadata: Metadata = { title: "Terms of Service — FRAMES" };
...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" updated="August 4, 2026">
      ...
      <p>
        These terms govern your use of FRAMES. By creating an account, you agree to them. FRAMES
      ...
      <h2>Eligibility</h2>
      <p>
        You must be at least 13 years old to use FRAMES. By creating an account you confirm you
      ...
      <h2>Your content</h2>
      <p>
        You own what you upload. By publishing a video on FRAMES, you grant us a license to host,
      ...
      <p>
        Content and behavior on FRAMES are governed by our{" "}
      ...
      <p>
        ...
        copyrighted work has been uploaded to FRAMES without permission, contact us via the{" "}
        <Link href="/contact">Contact</Link> page with a description of the work, its location
        on FRAMES, and your contact information.
      </p>
      ...
      <h2>Disclaimers</h2>
      <p>
        FRAMES is provided &ldquo;as is&rdquo; during this alpha period, without warranties of any
